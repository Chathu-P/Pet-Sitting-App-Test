...
const PetSitterDashboardScreen: React.FC = () => {
  ...
  >([]);
  const [requestType, setRequestType] = useState<"Accepted" | "Completed">(
    "Accepted",
  );
          ...
          <View style={styles.modalContent}>
            ...
            {loadingDetails ? (
              ...
              <ScrollView contentContainerStyle={{ padding: 20 }}>
                ...
                >
                  ...
                  <Text style={{ color: "#9CA3AF", fontSize: 12 }}>
                    ...
                    {selectedRequest.createdAt
                      ? formatDateVal(selectedRequest.createdAt)
                      : "N/A"}
                  </Text>
                </View>

                <Text style={styles.modalSectionTitle}>
                  Start Date : {formatDateVal(selectedRequest.startDate)}
                </Text>
                <Text style={[styles.modalSectionTitle, { marginTop: 4 }]}>
                  End Date : {formatDateVal(selectedRequest.endDate)}
                </Text>
                ...
                >
                  <Text
                    style={[styles.petName, { color: "#333", fontSize: 24 }]}
                  >
                  ...
                  >
                    <Text style={{ color: "#7C3AED", fontWeight: "bold" }}>
                      {selectedRequest.type || selectedRequest.petType}
                    </Text>
                  </View>
                </View>
                <Text style={{ color: "#666", marginTop: 4 }}>
                  {selectedRequest.breed ? selectedRequest.breed : "Breed: N/A"}{" "}
                  • {selectedRequest.age} years old
                </Text>
                ...
                >
                  ...
                  {selectedRequest.size && (
                    <View style={styles.tag}>
                      <Text style={styles.tagText}>{selectedRequest.size}</Text>
                    </View>
                  )}
                  ...
                  {selectedRequest.walkRequirement && (
                    <View style={styles.tag}>
                      <Text style={styles.tagText}>Walks Required</Text>
                    </View>
                  )}
                </View>
                ...
                >
                  ...
                  <Text style={{ color: "#431407" }}>
                    {selectedRequest.feedingSchedule || "Not specified"}
                  </Text>
                </View>
                ...
                <View style={styles.ownerCard}>
                  <View style={styles.infoRow}>
                    ...
                    <Text style={styles.infoText}>
                      {selectedOwner ? selectedOwner.fullName : "Unknown Owner"}
                    </Text>
                  </View>
                  {selectedOwner?.phone && (
                    <View style={styles.infoRow}>
                ...
                {(selectedRequest.emergencyContactName ||
                  ...
                  <View
                    style={[
                      styles.ownerCard,
                      { marginTop: 10, backgroundColor: "#FEFCE8" },
                    ]}
                  >
                    <Text
                      style={{
                ...
                <Text
                  style={{ color: "#555", lineHeight: 20, marginBottom: 4 }}
                >
                ...
                <Text
                  style={{ color: "#555", lineHeight: 22, fontStyle: "italic" }}
                >
                  "
                ...
                >
                  <Text
                    style={{ fontSize: 10, color: "#aaa", textAlign: "center" }}
                  >
                  ...
                  >
                    ...
                    {selectedRequest.acceptedAt
                      ? formatDateVal(selectedRequest.acceptedAt)
                      : "N/A"}
                  </Text>
                </View>
