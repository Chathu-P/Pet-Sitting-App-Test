...
const MessageItem: React.FC<MessageItemProps> = ({ item, isMe, styles }) => {
  const slideAnim = React.useRef(new Animated.Value(isMe ? 50 : -50)).current;
...
const ChatScreen = () => {
  ...
  return (
    <KeyboardAvoidingView
      ...
      keyboardVerticalOffset={60} // Adjust this value to match your header height
    >
      <ImageBackground
      ...
      >
        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            ...
            return <MessageItem item={item} isMe={isMe} styles={styles} />;
          }}
