...
const PetOwnerSignupScreen: React.FC = () => {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      navigation.navigate("PetOwnerDashboardScreen" as never);
    } catch (e: any) {
  ...
  return (
    <ImageBackground
      source={require("../../assets/signup/Petownersignup.png")}
      ...
      <SafeAreaView style={styles.safe}>
        ...
        >
          ...
          >
            ...
            >
              "Where pet parents connect with genuine caregivers."
            </Text>
            <Text
              style={[
...
export default PetOwnerSignupScreen;
